classdef Spawn < handle
    ...
    methods
        ...
        function CakeLocationSpawn(self)
            ...
            self.Cake_Locations= [
                %Middle Row
                self.tray_x,     self.tray_y+0.05,    self.tray_z...
                ;self.tray_x,     self.tray_y+0.1,    self.tray_z...
                ;self.tray_x,     self.tray_y-0.05,    self.tray_z...
                ;self.tray_x,     self.tray_y-0.1,    self.tray_z...
                %Left Row
                ;self.tray_x-0.09,     self.tray_y+0.05,    self.tray_z...
                ;self.tray_x-0.09,     self.tray_y+0.1,    self.tray_z...
                ;self.tray_x-0.09,     self.tray_y-0.05,    self.tray_z...
                ;self.tray_x-0.09,     self.tray_y-0.1,    self.tray_z...
                %Right Row
                ;self.tray_x+0.09,     self.tray_y+0.05,    self.tray_z...
